...
const HOST_EVENTS_REQUIREMENT_JSON: &str = r#"{"schema":"newengine.profiler.event_requirements.v1","topics":["engine.task.event.v1","engine.threading.event.v1","newengine.diagnostics.job.begin.v1","newengine.diagnostics.job.end.v1","newengine.diagnostics.job.status.v1","newengine.diagnostics.profiler.sample.v1"]}"#;
